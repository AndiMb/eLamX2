 ...
 */
public class InvABDMatrixPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        DecimalFormat largeFormat = GlobalProperties.getDefault().getFormat(GlobalProperties.FORMAT_INV_STIFFNESS);
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(InvABDMatrixPanel.class, "InvABDMatrixPanel.border.title"))); // NOI18N
    ...
    public void setValues(CLT_Laminate laminate) {
        ((MatrixTable)ABDTable).setMatrix(doubleArrayToDoubleArray(laminate.getInvABDMatrix()));
    }
    ...
    private class MatrixTable extends AutoRowHeightTable implements FocusListener {
        ...
        private DecimalFormat nf_ = (DecimalFormat)NumberFormat.getNumberInstance();
