...
public class CalculationOutputStreamImpl implements outputStreamService{
    ...
    public void writeToStream(Laminat laminate, PrintStream ps) {
        ...
        for (CalculationModuleData data : col){
            ...
            writeResults(System.out, data.getLaminat(), data.getDataHolder().getLoad(), data.getDataHolder().getStrains(), layerResults);
        }
    }

    private void writeResults(PrintStream out, Laminat laminate, Loads loads, Strains strain, CLT_LayerResult[] results){
