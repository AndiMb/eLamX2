 ...
 */
package de.elamx.laminate.addFailureCriteriaAbaqus;
...
/**
 *
 * @author Andres Hauffe
 */


public class AbaqusTsaiWu extends Criterion {

    public static final String F12_STAR = AbaqusTsaiWu.class.getName() + ".f12star";
    public static final String SIG_BIAX = AbaqusTsaiWu.class.getName() + ".sigbiax";

    public static AbaqusTsaiWu getDefault(FileObject obj) {
        AbaqusTsaiWu LSDtw = new AbaqusTsaiWu(obj);

        return LSDtw;
    }

    public AbaqusTsaiWu(FileObject obj) {
        super(obj);
    }
    ...
    public ReserveFactor getReserveFactor(Material material, Layer l, StressStrainState sss) {
        ...
        double sig_biax = material.getAdditionalValue(SIG_BIAX);
        ...
        if (sig_biax > 0 ) {
            F12 = (1 - (1 / material.getRParTen() + 1 / material.getRParCom() + 1 / material.getRNorTen() + 1 / material.getRNorCom()) * sig_biax + (1 / (material.getRParTen() * material.getRParCom()) + 1 / (material.getRNorTen() * material.getRNorCom())) * sig_biax * sig_biax); 
            F12 *= 1 / (2 * sig_biax * sig_biax);
        }
        ...
        if (Q == 0.0 && L == 0.0) {
            ...
            rf.setFailureName(NbBundle.getMessage(AbaqusTsaiWu.class, "AbaqusTsaiWu." + rf.getFailureName()));
        }
