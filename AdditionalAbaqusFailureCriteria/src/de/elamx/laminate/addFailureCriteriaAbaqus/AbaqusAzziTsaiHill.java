...
/**
 * Diese Klasse ist die Implementierung des Azzi-Tsai-Hill-Kriteriums.
 *
 * @author Andres Hauffe modifiziert Tim Dorau
 */
public class AbaqusAzziTsaiHill extends Criterion {

    public static AbaqusAzziTsaiHill getDefault(FileObject obj) {
        AbaqusAzziTsaiHill ath = new AbaqusAzziTsaiHill(obj);

        return ath;
    }

    public AbaqusAzziTsaiHill(FileObject obj) {
        super(obj);
    }
    ...
    public ReserveFactor getReserveFactor(Material material, Layer l, StressStrainState sss) {
        ...
        Q += 2.0 * F12 * Math.abs(stresses[0] * stresses[1]);
        ...
        if (Q == 0.0) {
            ...
            rf.setFailureName(NbBundle.getMessage(AbaqusAzziTsaiHill.class, "AbaqusAzziTsaiHill." + rf.getFailureName()));
        }
