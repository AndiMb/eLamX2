...
public class AutodeskTsaiWu extends Criterion {

    public static final String F12_STAR = AutodeskTsaiWu.class.getName() + ".f12star";
    public static final String SIG_BIAX = AutodeskTsaiWu.class.getName() + ".sigbiax";

    public static AutodeskTsaiWu getDefault(FileObject obj) {
        AutodeskTsaiWu LSDtw = new AutodeskTsaiWu(obj);

        return LSDtw;
    }

    public AutodeskTsaiWu(FileObject obj) {
        super(obj);
    }
    ...
    public ReserveFactor getReserveFactor(Material material, Layer l, StressStrainState sss) {
        ...
        if (Q == 0.0 && L == 0.0) {
            ...
            rf.setFailureName(NbBundle.getMessage(AutodeskTsaiWu.class, "AutodeskTsaiWu." + rf.getFailureName()));
        }
