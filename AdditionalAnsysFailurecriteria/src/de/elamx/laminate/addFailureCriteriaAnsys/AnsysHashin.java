 ...
 * @author Tim Dorau
 */
public class AnsysHashin extends Criterion {

    public static AnsysHashin getDefault(FileObject obj) {
        AnsysHashin AnHa = new AnsysHashin(obj);

        return AnHa;
    }

    public AnsysHashin(FileObject obj) {
        super(obj);
    }
    ...
    public ReserveFactor getReserveFactor(Material material, Layer l, StressStrainState sss) {
        ...
        rf.setFailureName(NbBundle.getMessage(AnsysHashin.class, "AnsysHashin." + rf.getFailureName()));
