...
public class DeformationConstraintDefintionServiceImpl extends ConstraintDefinitionService {

    public DeformationConstraintDefintionServiceImpl() {
        this(NbBundle.getMessage(DeformationModuleData.class, "DeformationModule.name"));
    }

    public DeformationConstraintDefintionServiceImpl(String name) {
        super(name);
    }

    @Override
    public Node getNewNode() {
        return new DeformationConstraintDefinitionNode();
    }
    ...
    public Node getNode(MinimalReserveFactorCalculator calculator) {
        if (calculator instanceof MinimalDeformationReserveFactorImpl) {
            return new DeformationConstraintDefinitionNode((MinimalDeformationReserveFactorImpl) calculator);
        }
        return null;
    }
