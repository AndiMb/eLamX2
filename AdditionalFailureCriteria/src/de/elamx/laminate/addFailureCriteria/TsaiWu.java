...
/**
 * Diese Klasse ist die Implementierung des Tsai-Wu-Kriteriums.
 *
 * @author Andreas Hauffe
 */
public class TsaiWu extends Criterion {

    public static final String F12_STAR = TsaiWu.class.getName() + ".f12star";

    public static TsaiWu getDefault(FileObject obj) {
        TsaiWu tw = new TsaiWu(obj);

        return tw;
    }

    public TsaiWu(FileObject obj) {
        super(obj);
    }
    ...
    public ReserveFactor getReserveFactor(Material material, Layer l, StressStrainState sss) {
        ...
        if (Q == 0.0 && L == 0.0) {
            ...
            rf.setFailureName(NbBundle.getMessage(TsaiWu.class, "TsaiWu." + rf.getFailureName()));
        }
