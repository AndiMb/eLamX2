 ...
 */
public class EParMicroMechModelProperty extends PropertySupport.ReadWrite<MicroMechModel> {
    ...
    public EParMicroMechModelProperty(MicroMechanicMaterial material) {
        super(MicroMechanicMaterial.PROP_EPARMODEL, MicroMechModel.class, NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.EParMicroMechModel"), NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.EParMicroMechModel.description"));
        this.htmlName = NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.EParMicroMechModel.html");
        this.mmMaterial = material;
        this.setName(MicroMechanicMaterial.PROP_EPARMODEL);
    }
    ...
    public MicroMechModel getValue() throws IllegalAccessException, InvocationTargetException {
        return mmMaterial.getEParModel();
    }

    @Override
    public PropertyEditor getPropertyEditor() {
        return new EParMechModelPropertyEditorSupport(mmMaterial);
    }
    ...
    public void setValue(MicroMechModel model) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        mmMaterial.setEParModel(model);
    }

    private class EParMechModelPropertyEditorSupport extends PropertyEditorSupport implements ExPropertyEditor, InplaceEditor.Factory {

        private final MicroMechanicMaterial mmMaterial;

        private EParMechModelPropertyEditorSupport(MicroMechanicMaterial mmMaterial) {
    ...
    private class Inplace extends JComboBox<MicroMechModel> implements InplaceEditor {
        ...
        public void setValue(Object object) {
            ...
            repaint();
            updateUI();
            mmMaterial.setEParModel((MicroMechModel) getSelectedItem());
            ((JComponent) getParent()).requestFocus();
        }
