 ...
 */
public class Nue12MicroMechModelProperty extends PropertySupport.ReadWrite<MicroMechModel> {
    ...
    public Nue12MicroMechModelProperty(MicroMechanicMaterial material) {
        super(MicroMechanicMaterial.PROP_EPARMODEL, MicroMechModel.class, NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.Nue12MicroMechModel"), NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.Nue12MicroMechModel.description"));
        this.htmlName = NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.Nue12MicroMechModel.html");
        this.mmMaterial = material;
        this.setName(MicroMechanicMaterial.PROP_NUE12MODEL);
    }
    ...
    public MicroMechModel getValue() throws IllegalAccessException, InvocationTargetException {
        return mmMaterial.getNue12Model();
    }

    @Override
    public PropertyEditor getPropertyEditor() {
        return new Nue12MechModelPropertyEditorSupport(mmMaterial);
    }
    ...
    public void setValue(MicroMechModel model) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        mmMaterial.setNue12Model(model);
    }

    private class Nue12MechModelPropertyEditorSupport extends PropertyEditorSupport implements ExPropertyEditor, InplaceEditor.Factory {

        private final MicroMechanicMaterial mmMaterial;

        private Nue12MechModelPropertyEditorSupport(MicroMechanicMaterial mmMaterial) {
    ...
    private class Inplace extends JComboBox<MicroMechModel> implements InplaceEditor {
        ...
        public void setValue(Object object) {
            ...
            repaint();
            updateUI();
            mmMaterial.setNue12Model((MicroMechModel) getSelectedItem());
            ((JComponent) getParent()).requestFocus();
        }
