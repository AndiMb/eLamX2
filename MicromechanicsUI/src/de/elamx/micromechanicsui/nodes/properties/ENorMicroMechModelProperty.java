 ...
 */
public class ENorMicroMechModelProperty extends PropertySupport.ReadWrite<MicroMechModel> {
    ...
    public ENorMicroMechModelProperty(MicroMechanicMaterial material) {
        super(MicroMechanicMaterial.PROP_EPARMODEL, MicroMechModel.class, NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.ENorMicroMechModel"), NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.ENorMicroMechModel.description"));
        this.htmlName = NbBundle.getMessage(MicroMechanicMaterialNode.class, "MicroMechanicMaterialNode.ENorMicroMechModel.html");
        this.mmMaterial = material;
        this.setName(MicroMechanicMaterial.PROP_ENORMODEL);
    }
    ...
    public MicroMechModel getValue() throws IllegalAccessException, InvocationTargetException {
        return mmMaterial.getENorModel();
    }

    @Override
    public PropertyEditor getPropertyEditor() {
        return new ENorMechModelPropertyEditorSupport(mmMaterial);
    }
    ...
    public void setValue(MicroMechModel model) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        mmMaterial.setENorModel(model);
    }

    private class ENorMechModelPropertyEditorSupport extends PropertyEditorSupport implements ExPropertyEditor, InplaceEditor.Factory {

        private final MicroMechanicMaterial mmMaterial;

        private ENorMechModelPropertyEditorSupport(MicroMechanicMaterial mmMaterial) {
    ...
    private class Inplace extends JComboBox<MicroMechModel> implements InplaceEditor {
        ...
        public void setValue(Object object) {
            ...
            repaint();
            updateUI();
            mmMaterial.setENorModel((MicroMechModel) getSelectedItem());
            ((JComponent) getParent()).requestFocus();
        }
