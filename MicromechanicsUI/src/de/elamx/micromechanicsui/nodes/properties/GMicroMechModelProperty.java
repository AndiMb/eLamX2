 ...
 */
public class GMicroMechModelProperty extends PropertySupport.ReadWrite<MicroMechModel> {
    ...
    public GMicroMechModelProperty(MicroMechanicMaterial material) {
        ...
        this.setName(MicroMechanicMaterial.PROP_GMODEL);
    }
    ...
    public MicroMechModel getValue() throws IllegalAccessException, InvocationTargetException {
        return mmMaterial.getGModel();
    }

    @Override
    public PropertyEditor getPropertyEditor() {
        return new GMechModelPropertyEditorSupport(mmMaterial);
    }
    ...
    public void setValue(MicroMechModel model) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        mmMaterial.setGModel(model);
    }

    private class GMechModelPropertyEditorSupport extends PropertyEditorSupport implements ExPropertyEditor, InplaceEditor.Factory {

        private final MicroMechanicMaterial mmMaterial;

        private GMechModelPropertyEditorSupport(MicroMechanicMaterial mmMaterial) {
    ...
    private class Inplace extends JComboBox<MicroMechModel> implements InplaceEditor {
        ...
        public void setValue(Object object) {
            ...
            repaint();
            updateUI();
            mmMaterial.setGModel((MicroMechModel) getSelectedItem());
            ((JComponent) getParent()).requestFocus();
        }
